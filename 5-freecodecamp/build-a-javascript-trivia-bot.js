...
let codingFact = favoriteLanguage + " can run both in the browser and on the server!";
...
codingFact = "I love " + favoriteLanguage + " because it's powerful and flexible!";
